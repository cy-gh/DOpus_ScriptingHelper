...
* ~~Probably the most important one: **The DOpus and DOpusFactory objects are not available yet!**~~ Fixed, DOpus object can be used freely, and `DOpus.create().Blob()`, etc. also do work.
